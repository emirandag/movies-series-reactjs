  ...
  return (
    <figure className='card' >
        ...
        {/* <button
                ...
                >{resFav.favoritos.some((fav) => fav.id == id) ? "💗" : "🤍" }</button> */}

{/* {resFav.favoritos.some((fav) => fav.id == id) ? 
<ButtonIcon variant='primary' theme={theme} onClick={() => actionClick()}><MdDeleteForever /></ButtonIcon> 
    :  */}
